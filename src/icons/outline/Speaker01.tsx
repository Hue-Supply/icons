...
const SvgSpeaker01 = (props: (SVGProps<SVGSVGElement> & { size?: string | number; color?: string })) => (
  <svg
  ...
  >
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M16 14.7a4 4 0 1 1-8 0 4 4 0 0 1 8 0M13 6.492a1 1 0 1 1-2 0 1 1 0 0 1 2 0"
    />
  </svg>
);
