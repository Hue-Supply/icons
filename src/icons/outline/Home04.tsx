...
const SvgHome04 = (props: (SVGProps<SVGSVGElement> & { size?: string | number; color?: string })) => (
  <svg
   ...
   fill={props.color || "currentColor"}>
    ...
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M9 16c0-.932 0-1.398.152-1.765a2 2 0 0 1 1.083-1.083C10.602 13 11.068 13 12 13s1.398 0 1.765.152a2 2 0 0 1 1.083 1.083C15 14.602 15 15.068 15 16v5H9z"
    />
  </svg>
);
